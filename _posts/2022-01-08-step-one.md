...
1. In the left navigation, click **+ Create**.
    ...
    ![Alt text](workshop-mr-powerapps/images/1-canvas-app.jpg)

    ![A screenshot of the Power Apps portal left navigation menu. The + Create button is highlighted.](././workshop-mr-powerapps/images/1-canvas-app.jpg)

(https://github.com/aprilspeight/workshop-mr-powerapps/blob/gh-pages/images/1-canvas-app.jpg)
